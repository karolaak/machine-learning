...
[trainingImages,validationImages] = splitEachLabel(images,0.7);
...
[predictedLabels,probs] = classify(net,augimdsValidation);
accuracy = mean(predictedLabels == validationImages.Labels)

idx = randperm(numel(validationImages.Files),4);
figure
for i = 1:4
    subplot(2,2,i)
